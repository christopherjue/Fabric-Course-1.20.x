package net.christopher.mccourse.world.biome.surface;
...
public class ModMaterialRules {
    ...
    private static final MaterialRules.MaterialRule PINK_GARNET = makeStateRule(ModBlocks.DEEPSLATE_PINK_GARNET_ORE);
    private static final MaterialRules.MaterialRule RAW_PINK_GARNET = makeStateRule(ModBlocks.PINK_GARNET_BLOCK);
