...
public class ModSlownessHoeItem extends HoeItem {
    public ModSlownessHoeItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings) {
    ...
    public boolean postHit(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        target.addStatusEffect(new StatusEffectInstance(StatusEffects.SLOWNESS, 600, 3), attacker);
